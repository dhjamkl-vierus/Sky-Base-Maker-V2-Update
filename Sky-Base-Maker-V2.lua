--[[ 
  Sky-Base-Maker-V2.lua - FIXED VERSION
  Fixed issues from original comparison
--]]

-- ======= Prevent double-run =======
if _G.SkyBaseMakerV2Loaded then return end
...
introFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 18)
...
loadingContainer.Position = UDim2.new(0.5, -200, 0.5, -90)
...
mainTitle.TextColor3 = Color3.fromRGB(200, 220, 255)
...
buttonsFrame.Position = UDim2.new(0,10,0,120)
...
-- raycast params (FIXED - using modern RaycastParams)
local rayParams = RaycastParams.new()
rayParams.FilterType = Enum.RaycastFilterType.Blacklist

-- ======= Raycast to find part under feet (FIXED) =======
...
local function updateSliderFromX(inputX)
    ...
    sliderValue = math.floor((relX / barSize) * 100)
